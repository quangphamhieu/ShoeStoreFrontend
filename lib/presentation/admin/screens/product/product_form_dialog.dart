    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Chọn ảnh', style: TextStyle(color: Colors.grey[600], fontSize: 14)),
        ],
      ),
    );
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                widget.editMode ? 'Sửa sản phẩm' : 'Thêm sản phẩm',
                          ...
                          TextFormField(
                            ...
                            decoration: _decoration('Tên sản phẩm', hint: 'Nhập tên sản phẩm', required: true),
                            textInputAction: TextInputAction.next,
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) return 'Vui lòng nhập tên sản phẩm';
                              return null;
                            },
                          ),
                              ...
                              Expanded(
                                child: DropdownButtonFormField<int?>(
                                  ...
                                  items: [
                                    ...
                                    ...brandProvider.brands.map((b) => DropdownMenuItem<int?>(value: b.id, child: Text(b.name))),
                                  ],
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: _decoration('Giá vốn', hint: '0', required: true),
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: _decoration('Giá gốc', hint: '0', required: true),
                                  keyboardType: TextInputType.number,
                                  textInputAction: TextInputAction.next,
                                  validator: (value) {
                                    if (value == null || value.trim().isEmpty) return 'Vui lòng nhập giá gốc';
                                    if (double.tryParse(value) == null) return 'Giá không hợp lệ';
                                    return null;
                                  },
                                ),
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: _decoration('Màu sắc', hint: 'Nhập màu sắc'),
                                  textInputAction: TextInputAction.next,
                                ),
                              ),
                              const SizedBox(width: 14),
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: _decoration('Kích thước', hint: 'Nhập kích thước'),
                                  textInputAction: TextInputAction.next,
                                ),
                              ),
                            ],
                          ...
                          TextFormField(
                            ...
                            maxLines: 3,
                            decoration: _decoration('Mô tả', hint: 'Mô tả sản phẩm'),
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                child: _loading
                                    ...
                                    : Text(widget.editMode ? 'Lưu thay đổi' : 'Tạo sản phẩm'),
                              ),
                            ],
                          ),
                        ],
