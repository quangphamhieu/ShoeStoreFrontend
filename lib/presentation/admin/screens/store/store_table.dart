              ...
              rows: stores.map((store) {
                ...
                return DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(Text(store.address?.isNotEmpty == true ? store.address! : '-')),
                    DataCell(Text(store.phone?.isNotEmpty == true ? store.phone! : '-')),
                    DataCell(
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                        decoration: BoxDecoration(
                          color: store.statusId == 1 ? const Color(0xFFEFFAF3) : const Color(0xFFFFF1F2),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          store.statusId == 1 ? 'Active' : 'Inactive',
                          style: TextStyle(
                            color: store.statusId == 1 ? const Color(0xFF0F9D58) : const Color(0xFFDC2626),
