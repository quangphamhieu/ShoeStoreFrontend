              ...
              rows: brands.map((b) {
                ...
                return DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(Text(b.description?.isNotEmpty == true ? b.description! : '-')),
                    DataCell(
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                        decoration: BoxDecoration(
                          color: b.statusId == 1 ? const Color(0xFFEFFAF3) : const Color(0xFFFFF1F2),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          b.statusId == 1 ? 'Active' : 'Inactive',
                          style: TextStyle(
                            color: b.statusId == 1 ? const Color(0xFF0F9D58) : const Color(0xFFDC2626),
