                  ...
                  cells: [
                    ...
                    DataCell(
                      ConstrainedBox(
                        ...
                        child: Text(
                          s.contactInfo?.isNotEmpty == true ? s.contactInfo! : '-',
                          softWrap: true,
                          maxLines: null,
                        ),
                      ),
                    ...
                    DataCell(
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: s.statusId == 1 ? const Color(0xFFEFFAF3) : const Color(0xFFFFF1F2),
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          s.statusId == 1 ? 'Active' : 'Inactive',
                          style: TextStyle(
                            color: s.statusId == 1 ? const Color(0xFF0F9D58) : const Color(0xFFDC2626),
