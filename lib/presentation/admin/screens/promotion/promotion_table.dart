              ...
              rows: promotions.map((p) {
                ...
                return DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(Text('${p.startDate.day}/${p.startDate.month}/${p.startDate.year}')),
                    DataCell(Text('${p.endDate.day}/${p.endDate.month}/${p.endDate.year}')),
                    DataCell(Center(child: Text(p.products.length.toString()))),
                    DataCell(
                      Container(
