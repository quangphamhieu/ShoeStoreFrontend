            ...
            children: [
              if (hasSelection) ...[
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      final success = await showDialog<bool>(
                        context: context,
                        builder: (_) => const PromotionFormDialog(editMode: true),
                      );
                ...
                Tooltip(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      final confirm = await showConfirmDeleteDialog(context, title: 'Xác nhận', content: 'Bạn có chắc muốn xóa khuyến mãi này?');
                      if (confirm == true) {
              ...
              ElevatedButton.icon(
                onPressed: () async {
                  ...
                  if (created == true && context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Thêm khuyến mãi thành công')));
                  }
                },
